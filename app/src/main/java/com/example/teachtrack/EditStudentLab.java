...
public class EditStudentLab extends AppCompatActivity implements View.OnClickListener {
    //View.OnClickListener allows the activity to handle click events on UI elements
    TextInputLayout[] textInputLayout = new TextInputLayout[15];//input fields of lab marks
    Button addNew;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //retrieve the data from the intent that started the activity including ID, pos, name and tableName
        ...
        //initializes editTextNameLabE as an EditText view by finding the view with the ID from xml
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    for(int i=0;i<13;i++){
                        //Retrieves the text entered in EditText fields named editText[i] and converts it to a string, storing it in s[i]
                        s[i] = editText[i].getText().toString();
                        //if empty set it to -1
                        if(s[i].equals("")){
                            s[i] = "-1";
                        }
                    }
