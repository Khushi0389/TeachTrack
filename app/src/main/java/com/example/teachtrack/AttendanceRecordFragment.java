...
public class AttendanceRecordFragment extends Fragment implements ScrollViewListener {
    ...
    String tableName;
    boolean interceptScroll = true; //flag that controls scroll synchronization between the two scrollview1 and 2
    private ObservableScrollView scrollview1 = null;
    private ObservableScrollView scrollview2 = null;

    public AttendanceRecordFragment() {
        // Required empty public constructor t o recreate the fragment if needed
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] attendance,columnName;
         ...
         // Retrieve student list and attendance records and column names
        ...
        // Create layout for displaying student IDs
        LinearLayout root1 = new LinearLayout(getActivity());
        // Create layout for displaying student names and attendance
